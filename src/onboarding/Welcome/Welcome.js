...
const Welcome = React.memo(function Welcome({
  ...
  return (
    ...
    >
      <Header
        title="AragonOS Test APP"
        subtitle="Friendly you can create your organization in few minutes in here."
      />
      ...
      >
        ...
        <Link href="https://github.com/zimenkoilya/AragonOS-Client-App" external>
          Click this
        </Link>
      </p>
    </Layout>
